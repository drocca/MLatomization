...
#        print classarray[loop0].coulomb
                while loop1 < 7102:
                    if (classarray[loop1].logic==1):
                        distance=numpy.linalg.norm(classarray[loop0].coulomb-classarray[loop1].coulomb)
                        kernel[m1][m2]=math.exp( -distance**2/(2.0*sigma**2) )
                        if (m1==m2):
                            kernel[m1][m2]=kernel[m1][m2]+lambdap
                        m2=m2+1
                    loop1=loop1+1
                m1=m1+1
            loop0=loop0+1
...
#        print classarray[loop0].coulomb
                while loop1 < 7102:
                    if (classarray[loop1].logic==2):
                        distance=numpy.linalg.norm(classarray[loop0].coulomb-classarray[loop1].coulomb)
                        elle[m1][m2]=math.exp( -distance**2/(2.0*sigma**2) )
                        m2=m2+1
                    loop1=loop1+1
                m1=m1+1
            loop0=loop0+1
...
#print prediction
        ...
        print "mae",jindex,iindex,mae/100
